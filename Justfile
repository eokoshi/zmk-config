...
draw: _check_yq_version
    ...
    keymap -c "{{ draw }}/config.yaml" draw "{{ draw }}/eyelash_corne.yaml" >"{{ draw }}/eyelash_corne.svg" 
    resvg "{{ draw }}/eyelash_corne.svg" "{{ draw }}/eyelash_corne.png"
